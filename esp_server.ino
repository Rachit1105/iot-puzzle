...
const int LED_PIN = 2;  // Define LED pin (using built-in LED on most ESP32 boards)
...
// Add handler for puzzle solved endpoint
...
void setup() {
  ...
  server.on("/puzzleSolved", HTTP_POST, handlePuzzleSolved);
